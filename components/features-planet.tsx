        ...
        <div className="pt-6 pb-12 md:pt-10 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-8 text-center md:pb-12">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              ACORD AL3 Engine: The Modern Standard
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Your Data, Your VPC. The engine runs entirely within your private AWS ECS/EKS cluster. No PII ever crosses the wire to our servers.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Hyper-Fast Go Engine</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                No JVM. No Bloat. Written in pure Golang, capable of processing 10,000+ policy files per second on a single vCPU.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Dual-Mode Ingestion</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Real-Time + Batch. Supports gRPC/HTTP for instant parsing and S3 Watcher for legacy file drops.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Type-Safe JSON Output</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Chaos into Structure. We convert AL3 text into strict, validated JSON, handling edge cases and encodings automatically.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>AWS Native Billing</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Simplified Procurement. Subscription and usage fees appear directly on your monthly AWS bill.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Helm-Ready Deployment</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                DevOps Friendly. Install with a single command. We provide standard Helm charts and Terraform modules.
              </p>
            </article>
          </div>
        </div>
